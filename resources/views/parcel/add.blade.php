...
{!! Form::open(['route' => 'parcels.store', 'files' => true, 'id' => 'parcel-form']) !!}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-md-3">
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-md-3">
                    <h5 class="card-title">
                        @lang('Informations Expéditeur')
                    </h5>
                    <p class="text-muted font-weight-light">
                        @lang('Informations générale sur le profil du Expéditeur.')
                    </p>
                </div>
                <div class="col-md-9">
                    @include('parcel.partials.sender', ['edit' => false, 'profile' => false])
                </div>
            </div>
        </div>
    </div>
